...
static void mma8652_calibration(void)
{
    ...
    bsp_i2c0_reg8_write(MMA8652_I2C_ADDR, MMA8652_CTRL_REG1, 0x00);

    bsp_i2c0_read((uint8_t)MMA8652_I2C_ADDR, (uint8_t *) mma8652_rxbuffer, sizeof(mma8652_rxbuffer));
    ...
    bsp_i2c0_reg8_write(MMA8652_I2C_ADDR, MMA8652_OFF_X_REG, x_offset);
    bsp_i2c0_reg8_write(MMA8652_I2C_ADDR, MMA8652_OFF_Y_REG, y_offset);
    bsp_i2c0_reg8_write(MMA8652_I2C_ADDR, MMA8652_OFF_Z_REG, z_offset);

    /* 0x11 to MMA8652_CTRL_REG1 activate */
    bsp_i2c0_reg8_write(MMA8652_I2C_ADDR, MMA8652_CTRL_REG1, 0x11);
}
...
void mma8652_init(void)
{
    ...
    bsp_i2c0_reg8_write(MMA8652_I2C_ADDR, MMA8652_CTRL_REG2, 0x02);
    ...
    */
    bsp_i2c0_reg8_write(MMA8652_I2C_ADDR, MMA8652_XYZ_DATA_CFG, 0x01);
